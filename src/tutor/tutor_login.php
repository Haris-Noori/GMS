...
<body>
    ...
    <div class="container mcontainer">
        ...
        <center>
            <h2>Tutor Login</h2>
            <!-- form -->
            <form action="tutor_login_try.php" method="post">

                <div class="form group-row">
                    <span><img src="../../img/perm_id.png"></span>
                    <input placeholder="Tutor Name" type="text" name="input_name" class="form-control col-sm-4" required>
                </div>
                <br>
                <div class="form group-row">
                    <span><img src="../../img/lock_open.png"></span>
                    <input placeholder="Tutor Password" type="password" name="input_pass" class="form-control col-sm-4" required>
                </div>
                <br>
                <div class="form group-row">
