        ...
        <center>
            ...
            <form action="student_login_try.php" method="post">
                ...
                <div class="form group-row">
                    ...
                    <input placeholder="Student Name" type="text" name="input_name" class="form-control col-sm-4" required>
                </div>
                <br>
                <div class="form group-row">
                    <span><img src="../../img/lock_open.png"></span>
                    <input placeholder="Student Password" type="password" name="input_pass" class="form-control col-sm-4" required>
                </div>
                <br>
                <div class="form group-row">
